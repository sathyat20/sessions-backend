...
<<<<<<< HEAD
    ...
    router.post("/:userId/clips", this.controller.postClip.bind(this.controller));
    router.put("/:userId/clips/:clipId", this.controller.putClip.bind(this.controller))
    router.delete("/:userId/clips/:clipId", this.controller.deleteClip.bind(this.controller))
    //user's artist interests methods
    router.get("/:userId/artists", this.controller.getArtists.bind(this.controller));
    router.post("/:userId/artists/", this.controller.addArtistInterest.bind(this.controller));
    router.delete("/:userId/artists/:artistId", this.controller.removeArtistInterest.bind(this.controller));
    //user's instruments methods
    router.get("/:userId/instruments", this.controller.getInstruments.bind(this.controller))
